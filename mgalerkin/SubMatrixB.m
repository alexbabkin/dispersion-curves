function retVal = SubMatrixB(kapa_nk_sh, kapa_nk, w, radius, n, A1, A2, de, intTol, begOfIntReg)
    ...
    retVal = coeff1 .* integral(unInt1, begOfIntReg, radius, 'AbsTol', intTol, 'ArrayValued', true) + ...
        coeff2 .* integral(unInt2, begOfIntReg, radius, 'AbsTol', intTol, 'ArrayValued', true) + ...
        coeff3 .* integral(unInt3, begOfIntReg, radius, 'AbsTol', intTol, 'ArrayValued', true);
